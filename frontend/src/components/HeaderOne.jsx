...
const HeaderOne = () => {
  ...
  return (
    <>
      ...
      {/* ======================= Middle Top End ========================= */}
      {/* ======================= Middle Header Start ========================= */}
      <header className='header-middle blur-bg border-bottom border-gray-100' style={{ position: 'relative', zIndex: 1000 }}>
        <div className='container container-lg'>
          <nav className='header-inner flex-between'>
            ...
            {/* Logo End  */}
            {/* form location Start */}
            <div className='flex-align flex-wrap form-location-wrapper' style={{ flexGrow: 1 }}>
              <div className='search-category d-flex h-48 select-border-end-0 radius-end-0 search-form d-sm-flex d-none' style={{ flexGrow: 1 }}>
                <select
                  defaultValue={1}
              ...
              <div className='location-box bg-white flex-align gap-8 py-6 px-16 rounded-pill border border-gray-100 ms-16'>
      ...
      {/* ==================== Header Start Here ==================== */}
      <header
        className={`header blur-bg border-bottom border-gray-100 ${
          scroll && "fixed-header"
        }`}
