          ...
          <nav className='header-inner flex-between'>
            ...
            <div className='flex-align gap-16'>
              ...
              <div className='flex-align flex-wrap form-location-wrapper' style={{ flexGrow: 1 }}>
                <div className='search-category style-two d-flex h-48 search-form d-sm-flex d-none w-100'>
                  <select
                  ...
                  <GlobalSearch 
                    wrapperStyle="w-100 h-100 d-flex"
                    inputStyle="search-form__input common-input py-13 ps-16 pe-18 rounded-0 border-0 w-100 h-100"
                    buttonStyle="w-32 h-32 bg-main-two-600 rounded-circle flex-center text-xl text-white position-absolute top-50 translate-middle-y inset-inline-end-0 me-8 hover-bg-main-two-700"
                  />
                </div>
              </div>
            </div>
