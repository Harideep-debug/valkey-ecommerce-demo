            ...
            <div className="container container-lg">
                ...
                <div className="row g-12">
                    <div className="col-md-4">
                        <div className="hot-deals tilt-card-3d neon-pulse-border position-relative rounded-16 bg-main-600 overflow-hidden p-28 z-1 text-center">
                            <img
                            ...
                            <div className="py-xl-4">
                                ...
                                <Link
                                    to="/shop"
                                    className="mt-16 btn btn-premium btn-premium-gradient-purple glitch-hover ripple fw-medium d-inline-flex align-items-center rounded-pill gap-8"
                                    tabIndex={0}
                                >
                                    Shop Now
