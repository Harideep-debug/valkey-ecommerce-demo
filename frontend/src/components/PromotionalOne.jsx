            ...
            <div className="container container-lg">
                <div className="row gy-4">
                    <div className="col-xl-3 col-sm-6 col-xs-6">
                        <div className="promotional-banner-item tilt-card-3d neon-pulse-border position-relative rounded-24 overflow-hidden z-1">
                            <img
                            ...
                            <div className="promotional-banner-item__content">
                                ...
                                <Link
                                    to="/shop"
                                    className="btn btn-premium btn-premium-gradient-purple ripple glitch-hover d-inline-flex align-items-center rounded-pill gap-8 mt-24"
                                >
                                    Shop Now
